            ...
            <form action="{{ROUTE('manage_account.update', $getId->account_id)}}" method="POST" role="form" enctype="multipart/form-data">
              ...
              <div class="card-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="account_password" value="{{ old('account_password', $getId->account_password) }}" class="form-control" id="exampleInputPassword1" placeholder="Enter new password">
                </div>
